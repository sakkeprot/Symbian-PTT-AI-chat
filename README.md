...
| Realm | `asterisk` |
| Username | `symbian` |
| Password | `yourpassword` yes its literally 'yourpassword', I think the server doesnt even check and allows everyone with username symbian but just do it to be sure |
| Transport type | `UDP` |
| Port | `5060` |
